/**
 * Lock 6-mode electric toothbrush aggregates after review import.
 */
...
const id = "91d25a5b-2fca-4629-9d34-3d1b3d141dcb";
const slug = "6-mode-electric-toothbrush";
const BREAKDOWN = [44, 1, 2, 0, 1];
