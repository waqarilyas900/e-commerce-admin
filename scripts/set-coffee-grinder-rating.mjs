/**
 * Lock mini electric coffee & spice grinder aggregates after review import.
 */
...
const id = "8bb50893-d681-4b12-bc7d-8da140ce2cca";
const slug = "mini-electric-coffee-and-spice-grinder";
const BREAKDOWN = [90, 7, 3, 0, 1];
