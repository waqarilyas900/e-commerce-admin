/**
 * Lock colorful mason glass mug aggregates after review import.
 */
...
const id = "c7df565f-766c-4417-ba74-cb48c91889a6";
const slug = "colorful-mason-glass-mug";
const BREAKDOWN = [16, 1, 1, 0, 0];
