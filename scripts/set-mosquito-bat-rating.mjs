/**
 * Lock rechargeable mosquito killer bat aggregates after review import.
 */
...
const id = "243a3932-22bf-4422-8d07-4bce72148bfa";
const slug = "rechargeable-mosquito-killer-bat";
const BREAKDOWN = [9, 0, 0, 0, 0];
