/**
 * Lock RGB lamp aggregates to Daraz totals after review import trigger.
 */
...
const id = "dc23faab-627b-428e-8ee1-e855741308c4";
const slug = "rgb-crystal-diamond-table-lamp";
const BREAKDOWN = [135, 3, 4, 0, 2];
