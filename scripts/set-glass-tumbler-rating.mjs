/**
 * Lock glass tumbler with straw & sleeve aggregates after review import.
 */
...
const id = "06be4ed1-7684-4f54-8330-58ee3f878cc0";
const slug = "glass-tumbler-with-straw-and-sleeve";
const BREAKDOWN = [109, 2, 1, 1, 2];
