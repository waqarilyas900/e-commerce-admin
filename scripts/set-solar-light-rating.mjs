/**
 * Lock 100W solar work light aggregates after review import.
 */
...
const id = "19fcb3e2-1816-437f-aada-72ee4ff825d0";
const slug = "100w-solar-led-work-light";
const BREAKDOWN = [35, 0, 2, 1, 0];
