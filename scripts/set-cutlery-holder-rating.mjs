/**
 * Lock 24-piece cutlery set with holder aggregates after review import.
 */
...
const id = "f57f3c9e-f0be-4cdc-9c9b-19a6e23f7f0e";
const slug = "24-piece-cutlery-set-with-holder";
const BREAKDOWN = [40, 0, 1, 0, 1];
