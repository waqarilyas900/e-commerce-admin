/**
 * Lock 304 vacuum insulated travel cup aggregates after review import.
 */
...
const id = "fa44ec7b-0571-46f3-986a-04a26d81b19f";
const slug = "304-vacuum-insulated-travel-cup";
const BREAKDOWN = [4, 1, 0, 0, 0];
