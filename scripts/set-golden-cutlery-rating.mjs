/**
 * Lock 24-piece golden cutlery set aggregates after review import.
 */
...
const id = "4601801e-5001-48d9-8806-8c3154b59c51";
const slug = "24-piece-golden-cutlery-set";
const BREAKDOWN = [23, 1, 2, 1, 0];
