/**
 * Lock multifunction kettle & egg boiler aggregates after review import.
 */
...
const id = "7f7b3871-38d3-45c3-9005-7b260932d7b4";
const slug = "multifunction-kettle-and-egg-boiler";
const BREAKDOWN = [144, 5, 1, 0, 8];
