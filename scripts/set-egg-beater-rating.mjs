/**
 * Lock handheld electric egg beater aggregates after review import.
 */
...
const id = "3be20ec3-a74a-4496-837d-5e11e9250ace";
const slug = "handheld-electric-egg-beater";
const BREAKDOWN = [19, 1, 0, 0, 0];
