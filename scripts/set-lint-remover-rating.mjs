/**
 * Lock lint remover aggregates after review import.
 */
...
const id = "7a3a0c11-08ea-4e46-a2b8-f14eb30d3d76";
const slug = "electric-fabric-lint-remover";
const BREAKDOWN = [43, 3, 0, 0, 0];
