/**
 * Lock 300ml wax warmer aggregates after review import.
 */
...
const id = "6227deef-d184-43d9-ab58-f8f48465e173";
const slug = "300ml-foldable-silicone-wax-warmer";
const BREAKDOWN = [95, 4, 0, 1, 3];
