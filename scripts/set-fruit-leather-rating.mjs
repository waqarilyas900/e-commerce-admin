/**
 * Lock fruit leather sheet roll aggregates after review import.
 */
...
const id = "491389a4-b437-4842-a9e7-a3756fa821f2";
const slug = "fruit-leather-sheet-roll-6-pack";
const BREAKDOWN = [6, 0, 0, 0, 0];
